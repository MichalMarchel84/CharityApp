...
<section id="profile" class="steps">
    <h2>Twoje konto</h2>
    <div class="steps--container">
        <div class="steps--item btn btn--large" style="padding: 10px">
...
<section id="donations" class="steps">
    ...
    <div class="table-cont">
        <table class="table">
            <tr>
                <th style="width: 15vw">Data odbioru</th>
                <th style="width: 20vw">Zawartość</th>
                <th style="width: 10vw">Ilość worków</th>
